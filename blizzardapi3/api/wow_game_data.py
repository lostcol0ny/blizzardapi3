...
class WowGameData:
    ...
    def get_auctions(self, *, region: Region | str, locale: Locale | str, connected_realm_id: int) -> ApiResponse:
        """Get auction house data for a connected realm."""
        return self._dynamic_get(region, locale, f"/data/wow/connected-realm/{connected_realm_id}/auctions")

    async def get_auctions_async(
        self, *, region: Region | str, locale: Locale | str, connected_realm_id: int
    ) -> ApiResponse:
        """Get auction house data for a connected realm."""
        return await self._dynamic_get_async(region, locale, f"/data/wow/connected-realm/{connected_realm_id}/auctions")
    ...
    def get_azerite_essences_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of azerite essences."""
        return self._static_get(region, locale, "/data/wow/azerite-essence/index")

    async def get_azerite_essences_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of azerite essences."""
        return await self._static_get_async(region, locale, "/data/wow/azerite-essence/index")

    def get_azerite_essence(self, *, region: Region | str, locale: Locale | str, essence_id: int) -> ApiResponse:
    ...
    async def get_azerite_essence_async(
        ...
        """Get an azerite essence by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/azerite-essence/{essence_id}")

    def search_azerite_essence(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
    ...
    async def search_azerite_essence_async(
        ...
        """Search for azerite essences."""
        return await self._static_get_async(region, locale, "/data/wow/search/azerite-essence", **filters)

    def get_azerite_essence_media(self, *, region: Region | str, locale: Locale | str, essence_id: int) -> ApiResponse:
        """Get media for an azerite essence."""
        return self._static_get(region, locale, f"/data/wow/media/azerite-essence/{essence_id}")

    async def get_azerite_essence_media_async(
        self, *, region: Region | str, locale: Locale | str, essence_id: int
    ) -> ApiResponse:
        """Get media for an azerite essence."""
        return await self._static_get_async(region, locale, f"/data/wow/media/azerite-essence/{essence_id}")
    ...
    def get_covenant_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of covenants."""
        return self._static_get(region, locale, "/data/wow/covenant/index")

    async def get_covenant_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of covenants."""
        return await self._static_get_async(region, locale, "/data/wow/covenant/index")

    def get_covenant(self, *, region: Region | str, locale: Locale | str, covenant_id: int) -> ApiResponse:
        """Get a covenant by ID."""
        return self._static_get(region, locale, f"/data/wow/covenant/{covenant_id}")

    async def get_covenant_async(self, *, region: Region | str, locale: Locale | str, covenant_id: int) -> ApiResponse:
        """Get a covenant by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/covenant/{covenant_id}")

    def get_covenant_media(self, *, region: Region | str, locale: Locale | str, covenant_id: int) -> ApiResponse:
    ...
    async def get_covenant_media_async(
        ...
        """Get media for a covenant."""
        return await self._static_get_async(region, locale, f"/data/wow/media/covenant/{covenant_id}")

    def get_soulbind_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of soulbinds."""
        return self._static_get(region, locale, "/data/wow/covenant/soulbind/index")

    async def get_soulbind_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of soulbinds."""
        return await self._static_get_async(region, locale, "/data/wow/covenant/soulbind/index")

    def get_soulbind(self, *, region: Region | str, locale: Locale | str, soulbind_id: int) -> ApiResponse:
        """Get a soulbind by ID."""
        return self._static_get(region, locale, f"/data/wow/covenant/soulbind/{soulbind_id}")

    async def get_soulbind_async(self, *, region: Region | str, locale: Locale | str, soulbind_id: int) -> ApiResponse:
        """Get a soulbind by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/covenant/soulbind/{soulbind_id}")

    def get_conduit_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of conduits."""
        return self._static_get(region, locale, "/data/wow/covenant/conduit/index")

    async def get_conduit_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of conduits."""
        return await self._static_get_async(region, locale, "/data/wow/covenant/conduit/index")

    def get_conduit(self, *, region: Region | str, locale: Locale | str, conduit_id: int) -> ApiResponse:
        """Get a conduit by ID."""
        return self._static_get(region, locale, f"/data/wow/covenant/conduit/{conduit_id}")

    async def get_conduit_async(self, *, region: Region | str, locale: Locale | str, conduit_id: int) -> ApiResponse:
        """Get a conduit by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/covenant/conduit/{conduit_id}")
    ...
    def get_heirloom_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of heirlooms."""
        return self._static_get(region, locale, "/data/wow/heirloom/index")

    async def get_heirloom_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of heirlooms."""
        return await self._static_get_async(region, locale, "/data/wow/heirloom/index")

    def get_heirloom(self, *, region: Region | str, locale: Locale | str, heirloom_id: int) -> ApiResponse:
        """Get an heirloom by ID."""
        return self._static_get(region, locale, f"/data/wow/heirloom/{heirloom_id}")

    async def get_heirloom_async(self, *, region: Region | str, locale: Locale | str, heirloom_id: int) -> ApiResponse:
        """Get an heirloom by ID."""
    ...
    async def get_decor_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of decor items."""
        return await self._static_get_async(region, locale, "/data/wow/decor/index")

    def get_decor(self, *, region: Region | str, locale: Locale | str, decor_id: int) -> ApiResponse:
        """Get a decor item by ID."""
        return self._static_get(region, locale, f"/data/wow/decor/{decor_id}")

    async def get_decor_async(self, *, region: Region | str, locale: Locale | str, decor_id: int) -> ApiResponse:
        """Get a decor item by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/decor/{decor_id}")

    def search_decor(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for decor items."""
        return self._static_get(region, locale, "/data/wow/search/decor", **filters)

    async def search_decor_async(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for decor items."""
        return await self._static_get_async(region, locale, "/data/wow/search/decor", **filters)

    def get_fixture_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of fixtures."""
        return self._static_get(region, locale, "/data/wow/fixture/index")

    async def get_fixture_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of fixtures."""
        return await self._static_get_async(region, locale, "/data/wow/fixture/index")

    def get_fixture(self, *, region: Region | str, locale: Locale | str, fixture_id: int) -> ApiResponse:
        """Get a fixture by ID."""
        return self._static_get(region, locale, f"/data/wow/fixture/{fixture_id}")

    async def get_fixture_async(self, *, region: Region | str, locale: Locale | str, fixture_id: int) -> ApiResponse:
        """Get a fixture by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/fixture/{fixture_id}")

    def search_fixture(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for fixtures."""
        return self._static_get(region, locale, "/data/wow/search/fixture", **filters)

    async def search_fixture_async(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for fixtures."""
        return await self._static_get_async(region, locale, "/data/wow/search/fixture", **filters)

    def get_fixture_hook_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of fixture hooks."""
        return self._static_get(region, locale, "/data/wow/fixture-hook/index")

    async def get_fixture_hook_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of fixture hooks."""
        return await self._static_get_async(region, locale, "/data/wow/fixture-hook/index")

    def get_fixture_hook(self, *, region: Region | str, locale: Locale | str, fixture_hook_id: int) -> ApiResponse:
    ...
    async def get_fixture_hook_async(
        ...
        """Get a fixture hook by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/fixture-hook/{fixture_hook_id}")

    def search_fixture_hook(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
    ...
    async def search_fixture_hook_async(
        ...
        """Search for fixture hooks."""
        return await self._static_get_async(region, locale, "/data/wow/search/fixture-hook", **filters)
    ...
    async def get_room_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of rooms."""
        return await self._static_get_async(region, locale, "/data/wow/room/index")

    def get_room(self, *, region: Region | str, locale: Locale | str, room_id: int) -> ApiResponse:
        """Get a room by ID."""
        return self._static_get(region, locale, f"/data/wow/room/{room_id}")

    async def get_room_async(self, *, region: Region | str, locale: Locale | str, room_id: int) -> ApiResponse:
        """Get a room by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/room/{room_id}")

    def search_room(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for rooms."""
        return self._static_get(region, locale, "/data/wow/search/room", **filters)

    async def search_room_async(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for rooms."""
    ...
    def get_item_appearance(self, *, region: Region | str, locale: Locale | str, appearance_id: int) -> ApiResponse:
    ...
    def get_item_appearance_set(
        ...
        return self._static_get(region, locale, f"/data/wow/item-appearance/set/{appearance_set_id}")
    ...
    def get_neighborhood_map_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of neighborhood maps."""
        return self._static_get(region, locale, "/data/wow/neighborhood-map/index")

    async def get_neighborhood_map_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of neighborhood maps."""
    ...
    def get_neighborhood_map(
        ...
        return self._static_get(region, locale, f"/data/wow/neighborhood-map/{neighborhood_map_id}")
    ...
    def get_item_sets_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of item sets."""
        return self._static_get(region, locale, "/data/wow/item-set/index")

    async def get_item_sets_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of item sets."""
        return await self._static_get_async(region, locale, "/data/wow/item-set/index")

    def get_item_set(self, *, region: Region | str, locale: Locale | str, set_id: int) -> ApiResponse:
        """Get an item set by ID."""
        return self._static_get(region, locale, f"/data/wow/item-set/{set_id}")

    async def get_item_set_async(self, *, region: Region | str, locale: Locale | str, set_id: int) -> ApiResponse:
        """Get an item set by ID."""
    ...
    def get_journal_expansions_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal expansions."""
        return self._static_get(region, locale, "/data/wow/journal-expansion/index")

    async def get_journal_expansions_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal expansions."""
        return await self._static_get_async(region, locale, "/data/wow/journal-expansion/index")

    def get_journal_expansion(self, *, region: Region | str, locale: Locale | str, expansion_id: int) -> ApiResponse:
        """Get a journal expansion by ID."""
        return self._static_get(region, locale, f"/data/wow/journal-expansion/{expansion_id}")

    async def get_journal_expansion_async(
        self, *, region: Region | str, locale: Locale | str, expansion_id: int
    ) -> ApiResponse:
        """Get a journal expansion by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/journal-expansion/{expansion_id}")

    def get_journal_encounters_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal encounters."""
        return self._static_get(region, locale, "/data/wow/journal-encounter/index")

    async def get_journal_encounters_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal encounters."""
        return await self._static_get_async(region, locale, "/data/wow/journal-encounter/index")

    def get_journal_encounter(self, *, region: Region | str, locale: Locale | str, encounter_id: int) -> ApiResponse:
        """Get a journal encounter by ID."""
        return self._static_get(region, locale, f"/data/wow/journal-encounter/{encounter_id}")

    async def get_journal_encounter_async(
        self, *, region: Region | str, locale: Locale | str, encounter_id: int
    ) -> ApiResponse:
        """Get a journal encounter by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/journal-encounter/{encounter_id}")

    def search_journal_encounter(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
    ...
    async def search_journal_encounter_async(
        ...
        """Search for journal encounters."""
        return await self._static_get_async(region, locale, "/data/wow/search/journal-encounter", **filters)

    def get_journal_instances_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal instances."""
        return self._static_get(region, locale, "/data/wow/journal-instance/index")

    async def get_journal_instances_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of journal instances."""
        return await self._static_get_async(region, locale, "/data/wow/journal-instance/index")

    def get_journal_instance(self, *, region: Region | str, locale: Locale | str, instance_id: int) -> ApiResponse:
        """Get a journal instance by ID."""
        return self._static_get(region, locale, f"/data/wow/journal-instance/{instance_id}")

    async def get_journal_instance_async(
        self, *, region: Region | str, locale: Locale | str, instance_id: int
    ) -> ApiResponse:
        """Get a journal instance by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/journal-instance/{instance_id}")

    def get_journal_instance_media(
        self, *, region: Region | str, locale: Locale | str, instance_id: int
    ) -> ApiResponse:
        """Get media for a journal instance."""
        return self._static_get(region, locale, f"/data/wow/media/journal-instance/{instance_id}")

    async def get_journal_instance_media_async(
        self, *, region: Region | str, locale: Locale | str, instance_id: int
    ) -> ApiResponse:
        """Get media for a journal instance."""
        return await self._static_get_async(region, locale, f"/data/wow/media/journal-instance/{instance_id}")
    ...
    def get_modified_crafting_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the modified crafting index."""
        return self._static_get(region, locale, "/data/wow/modified-crafting/index")

    async def get_modified_crafting_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the modified crafting index."""
        return await self._static_get_async(region, locale, "/data/wow/modified-crafting/index")

    def get_modified_crafting_category_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
    ...
    async def get_modified_crafting_category_index_async(
        ...
        """Get an index of modified crafting categories."""
        return await self._static_get_async(region, locale, "/data/wow/modified-crafting/category/index")

    def get_modified_crafting_category(
        self, *, region: Region | str, locale: Locale | str, category_id: int
    ) -> ApiResponse:
        """Get a modified crafting category by ID."""
        return self._static_get(region, locale, f"/data/wow/modified-crafting/category/{category_id}")

    async def get_modified_crafting_category_async(
        self, *, region: Region | str, locale: Locale | str, category_id: int
    ) -> ApiResponse:
        """Get a modified crafting category by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/modified-crafting/category/{category_id}")

    def get_modified_crafting_reagent_slot_type_index(
        self, *, region: Region | str, locale: Locale | str
    ) -> ApiResponse:
        """Get an index of modified crafting reagent slot types."""
        return self._static_get(region, locale, "/data/wow/modified-crafting/reagent-slot-type/index")

    async def get_modified_crafting_reagent_slot_type_index_async(
        self, *, region: Region | str, locale: Locale | str
    ) -> ApiResponse:
        """Get an index of modified crafting reagent slot types."""
        return await self._static_get_async(region, locale, "/data/wow/modified-crafting/reagent-slot-type/index")
    ...
    def get_mounts_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of mounts."""
        return self._static_get(region, locale, "/data/wow/mount/index")

    async def get_mounts_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of mounts."""
        return await self._static_get_async(region, locale, "/data/wow/mount/index")

    def get_mount(self, *, region: Region | str, locale: Locale | str, mount_id: int) -> ApiResponse:
        """Get a mount by ID."""
        return self._static_get(region, locale, f"/data/wow/mount/{mount_id}")

    async def get_mount_async(self, *, region: Region | str, locale: Locale | str, mount_id: int) -> ApiResponse:
        """Get a mount by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/mount/{mount_id}")

    def search_mount(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for mounts."""
        return self._static_get(region, locale, "/data/wow/search/mount", **filters)

    async def search_mount_async(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for mounts."""
    ...
    def get_mythic_keystone_affixes_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
    ...
    def get_mythic_keystone_affix(self, *, region: Region | str, locale: Locale | str, affix_id: int) -> ApiResponse:
    ...
    async def get_mythic_keystone_affix_async(
        ...
        """Get a mythic keystone affix by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/keystone-affix/{affix_id}")

    def get_mythic_keystone_affix_media(
        self, *, region: Region | str, locale: Locale | str, affix_id: int
    ) -> ApiResponse:
        """Get media for a mythic keystone affix."""
        return self._static_get(region, locale, f"/data/wow/media/keystone-affix/{affix_id}")

    async def get_mythic_keystone_affix_media_async(
        self, *, region: Region | str, locale: Locale | str, affix_id: int
    ) -> ApiResponse:
        """Get media for a mythic keystone affix."""
        return await self._static_get_async(region, locale, f"/data/wow/media/keystone-affix/{affix_id}")

    # ------------------------------------------------------------------
    # Mythic Keystone Dungeon / Index / Period / Season
    # ------------------------------------------------------------------

    def get_mythic_keystone_dungeons_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of mythic keystone dungeons."""
        return self._static_get(region, locale, "/data/wow/mythic-keystone/dungeon/index")

    async def get_mythic_keystone_dungeons_index_async(
        self, *, region: Region | str, locale: Locale | str
    ) -> ApiResponse:
        """Get an index of mythic keystone dungeons."""
        return await self._static_get_async(region, locale, "/data/wow/mythic-keystone/dungeon/index")
    ...
    def get_mythic_keystone_dungeon(
        ...
        return self._static_get(region, locale, f"/data/wow/mythic-keystone/dungeon/{dungeon_id}")

    async def get_mythic_keystone_dungeon_async(
        self, *, region: Region | str, locale: Locale | str, dungeon_id: int
    ) -> ApiResponse:
        """Get a mythic keystone dungeon by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/mythic-keystone/dungeon/{dungeon_id}")

    def get_mythic_keystone_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the mythic keystone index."""
        return self._dynamic_get(region, locale, "/data/wow/mythic-keystone/index")

    async def get_mythic_keystone_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the mythic keystone index."""
    ...
    def get_mythic_keystone_leaderboard(
        ...
        *,
        ...
        return self._dynamic_get(
            region,
            locale,
            f"/data/wow/connected-realm/{connected_realm_id}" f"/mythic-leaderboard/{dungeon_id}/period/{period_id}",
        )
    ...
    def get_mythic_raid_leaderboard(
        ...
        return self._dynamic_get(region, locale, f"/data/wow/leaderboard/hall-of-fame/{raid}/{faction}")

    async def get_mythic_raid_leaderboard_async(
        self, *, region: Region | str, locale: Locale | str, raid: str, faction: str
    ) -> ApiResponse:
        """Get the mythic raid hall of fame leaderboard."""
        return await self._dynamic_get_async(region, locale, f"/data/wow/leaderboard/hall-of-fame/{raid}/{faction}")
    ...
    async def get_pets_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of battle pets."""
        return await self._static_get_async(region, locale, "/data/wow/pet/index")

    def get_pet(self, *, region: Region | str, locale: Locale | str, pet_id: int) -> ApiResponse:
        """Get a battle pet by ID."""
        return self._static_get(region, locale, f"/data/wow/pet/{pet_id}")

    async def get_pet_async(self, *, region: Region | str, locale: Locale | str, pet_id: int) -> ApiResponse:
        """Get a battle pet by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/pet/{pet_id}")

    def get_pet_media(self, *, region: Region | str, locale: Locale | str, pet_id: int) -> ApiResponse:
        """Get media for a battle pet."""
        return self._static_get(region, locale, f"/data/wow/media/pet/{pet_id}")

    async def get_pet_media_async(self, *, region: Region | str, locale: Locale | str, pet_id: int) -> ApiResponse:
        """Get media for a battle pet."""
        return await self._static_get_async(region, locale, f"/data/wow/media/pet/{pet_id}")

    def get_pet_abilities_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of pet abilities."""
        return self._static_get(region, locale, "/data/wow/pet-ability/index")

    async def get_pet_abilities_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of pet abilities."""
        return await self._static_get_async(region, locale, "/data/wow/pet-ability/index")

    def get_pet_ability(self, *, region: Region | str, locale: Locale | str, ability_id: int) -> ApiResponse:
    ...
    async def get_pet_ability_async(
        ...
        """Get a pet ability by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/pet-ability/{ability_id}")

    def get_pet_ability_media(self, *, region: Region | str, locale: Locale | str, ability_id: int) -> ApiResponse:
        """Get media for a pet ability."""
        return self._static_get(region, locale, f"/data/wow/media/pet-ability/{ability_id}")

    async def get_pet_ability_media_async(
        self, *, region: Region | str, locale: Locale | str, ability_id: int
    ) -> ApiResponse:
        """Get media for a pet ability."""
        return await self._static_get_async(region, locale, f"/data/wow/media/pet-ability/{ability_id}")
    ...
    def get_playable_class_media(self, *, region: Region | str, locale: Locale | str, class_id: int) -> ApiResponse:
        """Get media for a playable class."""
        return self._static_get(region, locale, f"/data/wow/media/playable-class/{class_id}")

    async def get_playable_class_media_async(
        self, *, region: Region | str, locale: Locale | str, class_id: int
    ) -> ApiResponse:
        """Get media for a playable class."""
        return await self._static_get_async(region, locale, f"/data/wow/media/playable-class/{class_id}")

    def get_pvp_talent_slots(self, *, region: Region | str, locale: Locale | str, class_id: int) -> ApiResponse:
        """Get PvP talent slots for a playable class."""
        return self._static_get(region, locale, f"/data/wow/playable-class/{class_id}/pvp-talent-slots")

    async def get_pvp_talent_slots_async(
        self, *, region: Region | str, locale: Locale | str, class_id: int
    ) -> ApiResponse:
        """Get PvP talent slots for a playable class."""
        return await self._static_get_async(region, locale, f"/data/wow/playable-class/{class_id}/pvp-talent-slots")
    ...
    def get_playable_specializations_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
    ...
    async def get_playable_specializations_index_async(
        ...
        """Get an index of playable specializations."""
        return await self._static_get_async(region, locale, "/data/wow/playable-specialization/index")

    def get_playable_specialization(self, *, region: Region | str, locale: Locale | str, spec_id: int) -> ApiResponse:
        """Get a playable specialization by ID."""
        return self._static_get(region, locale, f"/data/wow/playable-specialization/{spec_id}")

    async def get_playable_specialization_async(
        self, *, region: Region | str, locale: Locale | str, spec_id: int
    ) -> ApiResponse:
        """Get a playable specialization by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/playable-specialization/{spec_id}")

    def get_playable_specialization_media(
        self, *, region: Region | str, locale: Locale | str, spec_id: int
    ) -> ApiResponse:
        """Get media for a playable specialization."""
        return self._static_get(region, locale, f"/data/wow/media/playable-specialization/{spec_id}")

    async def get_playable_specialization_media_async(
        self, *, region: Region | str, locale: Locale | str, spec_id: int
    ) -> ApiResponse:
        """Get media for a playable specialization."""
        return await self._static_get_async(region, locale, f"/data/wow/media/playable-specialization/{spec_id}")
    ...
    def get_professions_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of professions."""
        return self._static_get(region, locale, "/data/wow/profession/index")

    async def get_professions_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of professions."""
        return await self._static_get_async(region, locale, "/data/wow/profession/index")

    def get_profession(self, *, region: Region | str, locale: Locale | str, profession_id: int) -> ApiResponse:
    ...
    async def get_profession_async(
        ...
        """Get a profession by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/profession/{profession_id}")

    def get_profession_media(self, *, region: Region | str, locale: Locale | str, profession_id: int) -> ApiResponse:
        """Get media for a profession."""
        return self._static_get(region, locale, f"/data/wow/media/profession/{profession_id}")

    async def get_profession_media_async(
        self, *, region: Region | str, locale: Locale | str, profession_id: int
    ) -> ApiResponse:
        """Get media for a profession."""
        return await self._static_get_async(region, locale, f"/data/wow/media/profession/{profession_id}")
    ...
    def get_recipe(self, *, region: Region | str, locale: Locale | str, recipe_id: int) -> ApiResponse:
        """Get a recipe by ID."""
        return self._static_get(region, locale, f"/data/wow/recipe/{recipe_id}")

    async def get_recipe_async(self, *, region: Region | str, locale: Locale | str, recipe_id: int) -> ApiResponse:
        """Get a recipe by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/recipe/{recipe_id}")

    def get_recipe_media(self, *, region: Region | str, locale: Locale | str, recipe_id: int) -> ApiResponse:
    ...
    async def get_recipe_media_async(
        ...
        """Get media for a recipe."""
        return await self._static_get_async(region, locale, f"/data/wow/media/recipe/{recipe_id}")

    # ------------------------------------------------------------------
    # PvP Season / Leaderboard / Reward
    # ------------------------------------------------------------------

    def get_pvp_seasons_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP seasons."""
        return self._dynamic_get(region, locale, "/data/wow/pvp-season/index")

    async def get_pvp_seasons_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP seasons."""
        return await self._dynamic_get_async(region, locale, "/data/wow/pvp-season/index")

    def get_pvp_season(self, *, region: Region | str, locale: Locale | str, season_id: int) -> ApiResponse:
        """Get a PvP season by ID."""
        return self._dynamic_get(region, locale, f"/data/wow/pvp-season/{season_id}")

    async def get_pvp_season_async(self, *, region: Region | str, locale: Locale | str, season_id: int) -> ApiResponse:
        """Get a PvP season by ID."""
        return await self._dynamic_get_async(region, locale, f"/data/wow/pvp-season/{season_id}")

    def get_pvp_leaderboards_index(self, *, region: Region | str, locale: Locale | str, season_id: int) -> ApiResponse:
        """Get an index of PvP leaderboards for a season."""
        return self._dynamic_get(region, locale, f"/data/wow/pvp-season/{season_id}/pvp-leaderboard/index")

    async def get_pvp_leaderboards_index_async(
        self, *, region: Region | str, locale: Locale | str, season_id: int
    ) -> ApiResponse:
        """Get an index of PvP leaderboards for a season."""
        return await self._dynamic_get_async(region, locale, f"/data/wow/pvp-season/{season_id}/pvp-leaderboard/index")
    ...
    def get_pvp_leaderboard(
        ...
        *,
        ...
        return self._dynamic_get(region, locale, f"/data/wow/pvp-season/{season_id}/pvp-leaderboard/{bracket}")
    ...
    def get_pvp_rewards_index(self, *, region: Region | str, locale: Locale | str, season_id: int) -> ApiResponse:
        """Get an index of PvP rewards for a season."""
        return self._dynamic_get(region, locale, f"/data/wow/pvp-season/{season_id}/pvp-reward/index")

    async def get_pvp_rewards_index_async(
        self, *, region: Region | str, locale: Locale | str, season_id: int
    ) -> ApiResponse:
        """Get an index of PvP rewards for a season."""
        return await self._dynamic_get_async(region, locale, f"/data/wow/pvp-season/{season_id}/pvp-reward/index")

    # ------------------------------------------------------------------
    # PvP Tier
    # ------------------------------------------------------------------

    def get_pvp_tiers_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP tiers."""
        return self._static_get(region, locale, "/data/wow/pvp-tier/index")

    async def get_pvp_tiers_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP tiers."""
        return await self._static_get_async(region, locale, "/data/wow/pvp-tier/index")

    def get_pvp_tier(self, *, region: Region | str, locale: Locale | str, tier_id: int) -> ApiResponse:
        """Get a PvP tier by ID."""
        return self._static_get(region, locale, f"/data/wow/pvp-tier/{tier_id}")

    async def get_pvp_tier_async(self, *, region: Region | str, locale: Locale | str, tier_id: int) -> ApiResponse:
        """Get a PvP tier by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/pvp-tier/{tier_id}")

    def get_pvp_tier_media(self, *, region: Region | str, locale: Locale | str, tier_id: int) -> ApiResponse:
    ...
    async def get_pvp_tier_media_async(
        ...
        """Get media for a PvP tier."""
        return await self._static_get_async(region, locale, f"/data/wow/media/pvp-tier/{tier_id}")

    # ------------------------------------------------------------------
    # Quest
    # ------------------------------------------------------------------

    def get_quests_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quests."""
        return self._static_get(region, locale, "/data/wow/quest/index")

    async def get_quests_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quests."""
        return await self._static_get_async(region, locale, "/data/wow/quest/index")

    def get_quest(self, *, region: Region | str, locale: Locale | str, quest_id: int) -> ApiResponse:
        """Get a quest by ID."""
        return self._static_get(region, locale, f"/data/wow/quest/{quest_id}")

    async def get_quest_async(self, *, region: Region | str, locale: Locale | str, quest_id: int) -> ApiResponse:
        """Get a quest by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/quest/{quest_id}")

    def get_quest_categories_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest categories."""
        return self._static_get(region, locale, "/data/wow/quest/category/index")

    async def get_quest_categories_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest categories."""
        return await self._static_get_async(region, locale, "/data/wow/quest/category/index")

    def get_quest_category(self, *, region: Region | str, locale: Locale | str, category_id: int) -> ApiResponse:
    ...
    async def get_quest_category_async(
        ...
        """Get a quest category by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/quest/category/{category_id}")

    def get_quest_areas_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest areas."""
        return self._static_get(region, locale, "/data/wow/quest/area/index")

    async def get_quest_areas_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest areas."""
        return await self._static_get_async(region, locale, "/data/wow/quest/area/index")

    def get_quest_area(self, *, region: Region | str, locale: Locale | str, area_id: int) -> ApiResponse:
        """Get a quest area by ID."""
        return self._static_get(region, locale, f"/data/wow/quest/area/{area_id}")

    async def get_quest_area_async(self, *, region: Region | str, locale: Locale | str, area_id: int) -> ApiResponse:
        """Get a quest area by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/quest/area/{area_id}")

    def get_quest_types_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest types."""
        return self._static_get(region, locale, "/data/wow/quest/type/index")

    async def get_quest_types_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of quest types."""
        return await self._static_get_async(region, locale, "/data/wow/quest/type/index")

    def get_quest_type(self, *, region: Region | str, locale: Locale | str, type_id: int) -> ApiResponse:
        """Get a quest type by ID."""
        return self._static_get(region, locale, f"/data/wow/quest/type/{type_id}")

    async def get_quest_type_async(self, *, region: Region | str, locale: Locale | str, type_id: int) -> ApiResponse:
        """Get a quest type by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/quest/type/{type_id}")
    ...
    def get_reputation_factions_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of reputation factions."""
        return self._static_get(region, locale, "/data/wow/reputation-faction/index")

    async def get_reputation_factions_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of reputation factions."""
        return await self._static_get_async(region, locale, "/data/wow/reputation-faction/index")

    def get_reputation_faction(self, *, region: Region | str, locale: Locale | str, faction_id: int) -> ApiResponse:
        """Get a reputation faction by ID."""
        return self._static_get(region, locale, f"/data/wow/reputation-faction/{faction_id}")

    async def get_reputation_faction_async(
        self, *, region: Region | str, locale: Locale | str, faction_id: int
    ) -> ApiResponse:
        """Get a reputation faction by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/reputation-faction/{faction_id}")

    def get_reputation_tiers_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of reputation tiers."""
        return self._static_get(region, locale, "/data/wow/reputation-tiers/index")

    async def get_reputation_tiers_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of reputation tiers."""
        return await self._static_get_async(region, locale, "/data/wow/reputation-tiers/index")

    def get_reputation_tiers(self, *, region: Region | str, locale: Locale | str, tiers_id: int) -> ApiResponse:
    ...
    async def get_reputation_tiers_async(
        ...
        """Get reputation tiers by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/reputation-tiers/{tiers_id}")

    # ------------------------------------------------------------------
    # Spell
    # ------------------------------------------------------------------

    def get_spell(self, *, region: Region | str, locale: Locale | str, spell_id: int) -> ApiResponse:
        """Get a spell by ID."""
        return self._static_get(region, locale, f"/data/wow/spell/{spell_id}")

    async def get_spell_async(self, *, region: Region | str, locale: Locale | str, spell_id: int) -> ApiResponse:
        """Get a spell by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/spell/{spell_id}")

    def get_spell_media(self, *, region: Region | str, locale: Locale | str, spell_id: int) -> ApiResponse:
        """Get media for a spell."""
        return self._static_get(region, locale, f"/data/wow/media/spell/{spell_id}")

    async def get_spell_media_async(self, *, region: Region | str, locale: Locale | str, spell_id: int) -> ApiResponse:
        """Get media for a spell."""
        return await self._static_get_async(region, locale, f"/data/wow/media/spell/{spell_id}")

    def search_spell(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for spells."""
        return self._static_get(region, locale, "/data/wow/search/spell", **filters)

    async def search_spell_async(self, *, region: Region | str, locale: Locale | str, **filters: Any) -> ApiResponse:
        """Search for spells."""
    ...
    def get_talents_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of talents."""
        return self._static_get(region, locale, "/data/wow/talent/index")

    async def get_talents_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of talents."""
        return await self._static_get_async(region, locale, "/data/wow/talent/index")

    def get_talent(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a talent by ID."""
        return self._static_get(region, locale, f"/data/wow/talent/{talent_id}")

    async def get_talent_async(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a talent by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/talent/{talent_id}")

    def get_pvp_talents_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP talents."""
        return self._static_get(region, locale, "/data/wow/pvp-talent/index")

    async def get_pvp_talents_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of PvP talents."""
        return await self._static_get_async(region, locale, "/data/wow/pvp-talent/index")

    def get_pvp_talent(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a PvP talent by ID."""
        return self._static_get(region, locale, f"/data/wow/pvp-talent/{talent_id}")

    async def get_pvp_talent_async(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a PvP talent by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/pvp-talent/{talent_id}")

    def get_talent_tree_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of talent trees."""
        return self._static_get(region, locale, "/data/wow/talent-tree/index")

    async def get_talent_tree_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of talent trees."""
    ...
    def get_talent_tree_nodes(self, *, region: Region | str, locale: Locale | str, tree_id: int) -> ApiResponse:
    ...
    async def get_talent_tree_nodes_async(
        ...
        """Get talent tree nodes."""
        return await self._static_get_async(region, locale, f"/data/wow/talent-tree/{tree_id}")

    # ------------------------------------------------------------------
    # Tech Talent
    # ------------------------------------------------------------------

    def get_tech_talent_tree_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of tech talent trees."""
        return self._static_get(region, locale, "/data/wow/tech-talent-tree/index")

    async def get_tech_talent_tree_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of tech talent trees."""
        return await self._static_get_async(region, locale, "/data/wow/tech-talent-tree/index")

    def get_tech_talent_tree(self, *, region: Region | str, locale: Locale | str, tree_id: int) -> ApiResponse:
    ...
    async def get_tech_talent_tree_async(
        ...
        """Get a tech talent tree by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/tech-talent-tree/{tree_id}")

    def get_tech_talent_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of tech talents."""
        return self._static_get(region, locale, "/data/wow/tech-talent/index")

    async def get_tech_talent_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of tech talents."""
        return await self._static_get_async(region, locale, "/data/wow/tech-talent/index")

    def get_tech_talent(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a tech talent by ID."""
        return self._static_get(region, locale, f"/data/wow/tech-talent/{talent_id}")

    async def get_tech_talent_async(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get a tech talent by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/tech-talent/{talent_id}")

    def get_tech_talent_media(self, *, region: Region | str, locale: Locale | str, talent_id: int) -> ApiResponse:
        """Get media for a tech talent."""
        return self._static_get(region, locale, f"/data/wow/media/tech-talent/{talent_id}")

    async def get_tech_talent_media_async(
        self, *, region: Region | str, locale: Locale | str, talent_id: int
    ) -> ApiResponse:
        """Get media for a tech talent."""
        return await self._static_get_async(region, locale, f"/data/wow/media/tech-talent/{talent_id}")

    # ------------------------------------------------------------------
    # Title / Toy / Token
    # ------------------------------------------------------------------

    def get_titles_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of titles."""
        return self._static_get(region, locale, "/data/wow/title/index")

    async def get_titles_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of titles."""
        return await self._static_get_async(region, locale, "/data/wow/title/index")

    def get_title(self, *, region: Region | str, locale: Locale | str, title_id: int) -> ApiResponse:
        """Get a title by ID."""
        return self._static_get(region, locale, f"/data/wow/title/{title_id}")

    async def get_title_async(self, *, region: Region | str, locale: Locale | str, title_id: int) -> ApiResponse:
        """Get a title by ID."""
    ...
    async def get_toy_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get an index of toys."""
        return await self._static_get_async(region, locale, "/data/wow/toy/index")

    def get_toy(self, *, region: Region | str, locale: Locale | str, toy_id: int) -> ApiResponse:
        """Get a toy by ID."""
        return self._static_get(region, locale, f"/data/wow/toy/{toy_id}")

    async def get_toy_async(self, *, region: Region | str, locale: Locale | str, toy_id: int) -> ApiResponse:
        """Get a toy by ID."""
        return await self._static_get_async(region, locale, f"/data/wow/toy/{toy_id}")

    def get_token_index(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the WoW token index."""
        return self._dynamic_get(region, locale, "/data/wow/token/index")

    async def get_token_index_async(self, *, region: Region | str, locale: Locale | str) -> ApiResponse:
        """Get the WoW token index."""
